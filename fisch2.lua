--[[
    Project: Fisch Hub (Fully Fixed Edition)
    Author: MrDon
]]
...
-- Corrected official map coordinates for Fisch islands
local islands = {
...
RunService.RenderStepped:Connect(function()
    pcall(function()
        ...
        if playerGui then
            -- Auto Shake / Auto Fish Handling
            if Config.AutoFish then
                local shakeUI = playerGui:FindFirstChild("shake") 
                    or playerGui:FindFirstChild("Minigame") 
                    or playerGui:FindFirstChild("reel")
                
                if shakeUI then
                    for _, v in ipairs(shakeUI:GetDescendants()) do
            ...
            -- Instant Catch Handling
            if Config.InstantCatch then
                local reelUI = playerGui:FindFirstChild("reel") or playerGui:FindFirstChild("Minigame")
                if reelUI then
                    local progress = reelUI:FindFirstChild("bar") or reelUI:FindFirstChild("progress")
