--[[
    Project: Fisch Hub (Bar Follow Fish Edition)
    Author: MrDon
]]
...
-- Engine loops for Fly, Auto-Shake, and Bar Following
local BV, BG
RunService.RenderStepped:Connect(function()
    pcall(function()
        ...
        if playerGui then
            ...
            -- 2. Bar Follow Fish Handler (Locks rod bar position to match fish icon)
